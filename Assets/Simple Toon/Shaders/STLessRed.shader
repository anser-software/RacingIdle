Shader "Simple Toon/SToon Replace Red"
{
    Properties
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                fixed4 frag(v2f i) : SV_Target
                {
                    ...
                    //fixed4 litcol = ColorBlend(_Color, _LightColor0, 0);
                    //fixed4 texcol = tex2D(_MainTex, i.uv) * litcol * _ColIntense + _ColBright;
                    fixed4 texcol = tex2D(_MainTex, i.uv) * _ColIntense + _ColBright;

                    if (texcol.r > (texcol.g + texcol.b))
                        texcol = _Color * _ColIntense + _ColBright;
